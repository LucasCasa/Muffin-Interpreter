...
public interface Cond{
  public Boolean eval(VarList vl);
}
...
/*public class Cond {
    ...
    public Cond( Cond b1, Cond b2,String op){
    }
    public static Boolean eval(){
          if(op == "AND"){
            return new Boolean(b1.eval() && b2.eval());
          }else if(op == "OR"){
            return new Boolean(b1.eval() || b2.eval());
          }else{
            return null;
    ...
    /*public static Boolean compare(Object o1, Object o2, String s1){
      if(o1 instanceof Integer && o2 instanceof Integer){
        return cmpInt((Integer) o1,(Integer) o2,s1);
      }else if(o1 instanceof String && o2 instanceof String){
        return cmpStr((String) o1,(String) o2,s1);
      }else{
        return null;
      }
    }
    private static Boolean cmpInt(Integer i1, Integer i2,String s1){
      if(s1 == "<"){
        return new Boolean(i1.intValue() < i2.intValue());
      }else if(s1 == ">"){
        return new Boolean(i1.intValue() > i2.intValue());
      }else if(s1 == "<="){
        return new Boolean(i1.intValue() <= i2.intValue());
    ...
    private static Boolean cmpStr(String s1, String s2,String cmp){
      if(cmp == "<"){
        return new Boolean(s1.compareTo(s2) > 0);
      }else if(cmp == ">"){
        return new Boolean(s1.compareTo(s2) < 0);
      }else if(cmp == "<="){
        return new Boolean(s1.compareTo(s2) <= 0);
        ...
        return new Boolean(s1.equals(s2));
      }else if(cmp == "!="){
        return new Boolean(!s1.equals(s2));
      }else{
        return null;
  ...
  //   public static Boolean eval
  //   public static class EvalBoolean extends Cond {
  // 	     EvalBoolean e1;
  //        EvalBoolean e2;
  //        Evaluator   ev;
	//      public EvalBoolean(EvalBoolean e1, EvalBoolean e2, Evaluator ev){
	//          this.e1=e1;
  //          this.e2=e2;
  //          this.e1=e1;
	//     }
  //     public EvalBoolean evaluate(){
  //
  //     }
